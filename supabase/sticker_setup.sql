...
VALUES
  ('sticker', '공오 스티커', '공오가 슬쩍 붙어있다', 'research_records', 0, 'active',
   '../images/shop/sticker_free_05.png', 'sticker-free-05', '기본', 10);
...
BEGIN
  ...
  INSERT INTO public.user_equipment (user_id, equipped_sticker_id, updated_at)
...
BEGIN
  ...
  RETURN json_build_object('success', true, 'equipped_sticker_id', null);
END;
$$;
